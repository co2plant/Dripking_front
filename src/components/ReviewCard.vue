      ...
      <div class="flex items-center mb-2">
        <div class="flex mr-2">
          <template v-for="i in 5" :key="i">
            <svg class="w-5 h-5" :class="i <= review.rating ? 'text-yellow-400' : 'text-gray-300'" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
<!--      </div>-->
    ...
    <div class="text-xs text-gray-500 mt-4 pt-2 border-t border-gray-100">
      ...
      <span v-if="formatDate(review.modifiedTime) !== formatDate(review.createdTime)">
        (수정됨)
      </span>
    </div>
  </div>
